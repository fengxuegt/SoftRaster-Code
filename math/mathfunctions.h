...
namespace math {
	...
	*/
	...
	static vec2f lerp2(const vec2f &v1, const vec2f &v2, const vec2f &v3, const float& weight1, const float& weight2, const float& weight3) {
		return v1 * weight1 + v2 * weight2 + v3 * weight3;
	}

}

#endif //GRAPHIC_MATHFUNCTIONS_H
